...
public class ChattingController {
	...
	public AjaxResult<Page<Long>> pageList() {
		return AjaxResult.success(chattingService.pageList());
	}
	...
	public AjaxResult<Long> detail(@PathVariable("id") Long id) {
		return AjaxResult.success(chattingService.detail(id));
	}
	...
	public AjaxResult<Long> add() {
		return AjaxResult.success(chattingService.add());
	}
