...
public class UserCopyController {
	...
	public AjaxResult<Page<Long>> pageList() {
		return AjaxResult.success(userCopyService.pageList());
	}
	...
	public AjaxResult<Long> detail(@PathVariable("id") Long id) {
		return AjaxResult.success(userCopyService.detail(id));
	}
	...
	public AjaxResult<Long> add() {
		return AjaxResult.success(userCopyService.add());
	}
