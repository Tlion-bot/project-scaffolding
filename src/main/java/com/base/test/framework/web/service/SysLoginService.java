...
import com.base.test.framework.security.provider.PhoneCodeAuthenticationToken;
import com.base.test.framework.security.provider.WrongPhoneCodeException;
    ...
    public String login(LoginBody loginBody) {
        ...
        try {
            if (StrUtil.isNotBlank(loginBody.getPhoneCode())) {
                authentication = authenticationManager.authenticate(new PhoneCodeAuthenticationToken(loginBody.getUsername(), loginBody.getPhoneCode()));
            } else {
