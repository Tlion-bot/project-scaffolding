...
import com.base.test.common.config.BaseWorkConfig;
...
import com.base.test.framework.config.properties.TokenProperties;
...
public class TokenService {
    ...
    public LoginUser getLoginUser(HttpServletRequest request) {
        ...
        if (Validator.isNotEmpty(token)) {
            ...
            // 解析对应的权限以及用户信息
            String uuid = (String) claims.get(BaseWorkConfig.getName() + Constants.LOGIN_USER_KEY);
    ...
    public String createToken(LoginUser loginUser) {
        ...
        claims.put(BaseWorkConfig.getName() + Constants.LOGIN_USER_KEY, token);
