...
public class SecurityUtils {
    ...
    public static boolean isLogin() {
        return null != getAuthentication() && getAuthentication().isAuthenticated()
                && null != getAuthentication().getPrincipal() && getAuthentication().getPrincipal() instanceof LoginUser;
    }
