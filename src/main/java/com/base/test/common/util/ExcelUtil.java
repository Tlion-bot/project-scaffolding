...
import com.base.test.common.annotation.Excel.ColumnType;
import com.base.test.common.annotation.Excel.Type;
import com.base.test.common.annotation.Excels;
...
import com.base.test.common.utils.DictUtils;
import com.base.test.common.utils.file.FileTypeUtils;
import com.base.test.common.utils.file.ImageUtils;
import com.base.test.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T>
{
     ...
     * @return 结果
     */
    public AjaxResult exportExcelNew(List<T> list, String sheetName, HttpServletResponse response) {
        this.init(list, sheetName, Excel.Type.EXPORT);
        return exportExcelNew(response);
    }
     ...
     * @return 结果
     */
    public AjaxResult exportExcelNew(HttpServletResponse response) {
        OutputStream out = null;
        try {
            // 取出一共有多少个sheet.
            double sheetNo = Math.ceil(list.size() / sheetSize);
            ...
            String filename = encodingFilenameNew(sheetName);
            // 设置输出的格式
...
// 定义浏览器响应表头，顺带定义下载名
     ...
     * 编码文件名
     */
    public String encodingFilenameNew(String filename)
    {
